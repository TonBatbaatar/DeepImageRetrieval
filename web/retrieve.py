...
import metrics.arcface as arcface
import metrics.cosface as cosface

modelpath = {"contrastive":"static/program/Contrastive/contrastive.pth",
...
csvpath = {"contrastive":"static/program/Contrastive/embedding_space.csv",
